...
// 1. 获取当前文件所在的目录 (native/killProcess)
...
// 生产环境路径
const prodPath = path.join(__dirname, '../../native/killProcess/build/Release', 'killProcess.node');
...
// 或者在这里手动添加导出，例如：
export const killProcess = nativeModule.killProcess;
